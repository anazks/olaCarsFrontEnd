import { LayoutDashboard, Users, CalendarCheck, ClipboardList, Wallet, BellRing, Settings } from 'lucide-react';
...
const BranchManagerSidebar = () => {
    return (
        <aside className="w-64 h-full flex flex-col flex-shrink-0" style={{ background: '#0A0A0A', borderRight: '1px solid #2A2A2A' }}>
            ...
            <div className="px-5 py-4 text-xs font-bold text-gray-500 tracking-wider">L3: BRANCH MGR</div>
