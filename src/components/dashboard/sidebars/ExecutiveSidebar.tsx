    ...
    const menuItems: MenuItem[] = [
        {
            ...
            subItems: [
                ...
                { label: t('sidebar.items.collectionsDashboard'), path: '/admin/admin/collections/dashboard' },
                { label: t('sidebar.items.fleetDashboard'), path: '/admin/admin/driver-performance', permission: 'STAFF_PERFORMANCE_VIEW' },
                { label: t('sidebar.items.financeDashboard'), path: '/admin/admin/finance-dashboard', permission: 'REPORTS_VIEW' },
                { label: t('sidebar.items.wGroup'), path: '/admin/admin/wgroup-dashboard', badge: 'BETA' },
            ]
        },
        {
            id: 'staff',
            ...
            icon: <Users size={22} />,
            subItems: [
                { label: t('sidebar.items.staffManagement'), path: '/admin/admin/staff-management', permission: 'STAFF_VIEW' },
                { label: t('sidebar.items.staffPerformance'), path: '/admin/admin/staff-performance', permission: 'STAFF_PERFORMANCE_VIEW' },
                { label: t('sidebar.items.directivesDelegation'), path: '/admin/admin/directives', permission: 'STAFF_PERFORMANCE_VIEW' },
            ]
        },
        {
            id: 'administration',
            ...
            subItems: [
                { label: t('sidebar.items.manageBranches'), path: '/admin/admin/manage-branches', permission: 'BRANCH_VIEW' },
                { label: t('sidebar.items.manageSuppliers'), path: '/admin/admin/manage-suppliers', permission: 'SUPPLIER_VIEW' },
            ]
        },
        {
            id: 'operations',
            ...
            icon: <Car size={22} />,
            subItems: [
                { label: t('sidebar.items.manageVehicles'), path: '/admin/admin/vehicles', permission: 'VEHICLE_VIEW' },
                { label: t('sidebar.items.pendingEntryVehicles'), path: '/admin/admin/pending-vehicles', permission: 'VEHICLE_VIEW' },
                { label: t('sidebar.items.manageDrivers'), path: '/admin/admin/drivers', permission: 'DRIVER_VIEW' },
                { label: t('sidebar.items.legalAgreements'), path: '/admin/admin/agreements', permission: 'AGREEMENT_VIEW' },
                { label: t('sidebar.items.intelligenceReports'), path: '/admin/admin/reports', permission: 'REPORTS_VIEW' },
                { label: t('sidebar.items.accidentReports'), path: '/admin/admin/accident-reports', permission: 'STAFF_VIEW' },
            ]
        },
        {
            id: 'collections',
            ...
            subItems: [
                { label: t('sidebar.items.collectionsDashboard'), path: '/admin/admin/collections/dashboard' },
                { label: t('sidebar.items.overduePayments'), path: '/admin/admin/collections/overdue' },
                { label: t('sidebar.items.upcomingPayments'), path: '/admin/admin/collections/upcoming' },
                { label: t('sidebar.items.invoicesLedger'), path: '/admin/admin/collections/invoices' },
            ]
        },
        {
            id: 'sales',
            ...
            subItems: [
                ...
                { label: t('sidebar.items.paymentsReceived'), path: '/admin/admin/payments-received' },
                { label: t('sidebar.items.creditNotes'), path: '/admin/admin/credit-notes' },
            ]
        },
        {
            id: 'purchases',
            ...
            subItems: [
                { label: t('sidebar.items.vendors'), path: '/admin/admin/manage-suppliers', permission: 'SUPPLIER_VIEW' },
                { label: t('sidebar.items.expenses'), path: '/admin/admin/expenses' },
                { label: t('sidebar.items.purchaseOrders'), path: '/admin/admin/purchase-orders', permission: 'PURCHASE_ORDER_VIEW' },
                { label: t('sidebar.items.purchaseRequests'), path: '/admin/admin/workshop-purchase-requests', permission: 'PURCHASE_ORDER_VIEW' },
                { label: t('sidebar.items.bills'), path: '/admin/admin/bills' },
                { label: t('sidebar.items.paymentsMade'), path: '/admin/admin/payments-made' },
            ]
        },
        {
            id: 'finance',
        ...
        },
        {
            ...
            subItems: [
                { label: t('sidebar.items.systemPreferences'), path: '/admin/admin/dashboard-settings' },
                { label: t('sidebar.items.systemBulkUploads'), path: '/admin/admin/bulk-uploads' },
            ]
        },
    ];
