...
import { LayoutDashboard, CarFront, FileText, ShieldCheck, Settings, LogOut, Menu, Building2, UserCheck, Users, ChevronDown, ChevronRight, Calculator, BarChart3, Target, ClipboardList } from 'lucide-react';
...
const ExecutiveSidebar = ({ isSidebarCollapsed = false, toggleSidebar }: ExecutiveSidebarProps) => {
    ...
    const staffItems = [
        { icon: <Users size={20} />, label: t('sidebar.items.staffManagement', 'Staff Management'), path: '/admin/admin/staff-management', permission: 'STAFF_VIEW' },
