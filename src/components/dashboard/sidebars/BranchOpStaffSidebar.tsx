...
const BranchOpStaffSidebar = ({
  ...
  const userRole = "Operations Staff";
  ...
  const isActive = (path: string) => {
    ...
    if (path === "/admin/branch-op-staff") {
      return location.pathname === "/admin/branch-op-staff";
    }
      ...
      subItems: [
        {
          ...
          path: "/admin/branch-op-staff/my-tasks",
        },
        {
          label: t("sidebar.items.directivesDelegation"),
          path: "/admin/branch-op-staff/directives",
        },
        {
          label: t("sidebar.items.accidentReports"),
          path: "/admin/branch-op-staff/accident-reports",
        },
        {
          label: t("sidebar.items.manageVehicles"),
          path: "/admin/branch-op-staff/vehicles",
        },
        {
          label: t("sidebar.items.pendingEntryVehicles"),
          path: "/admin/branch-op-staff/pending-vehicles",
        },
        {
          label: t("sidebar.items.manageDrivers"),
          path: "/admin/branch-op-staff/drivers",
        },
        {
          label: t("sidebar.items.fleetPerformance"),
          path: "/admin/branch-op-staff/driver-performance",
        },
        {
          label: t("sidebar.items.supportDesk"),
          path: "/admin/branch-op-staff/complaints",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          path: "/admin/branch-op-staff/collections/dashboard",
        },
        {
          label: t("sidebar.items.overduePayments"),
          path: "/admin/branch-op-staff/collections/overdue",
        },
        {
          label: t("sidebar.items.upcomingPayments"),
          path: "/admin/branch-op-staff/collections/upcoming",
        },
        {
          label: t("sidebar.items.invoicesLedger"),
          path: "/admin/branch-op-staff/collections/invoices",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          path: "/admin/branch-op-staff/dashboard-settings",
        },
        {
          label: t("sidebar.items.systemBulkUploads"),
          path: "/admin/branch-op-staff/bulk-uploads",
        },
      ],
    },
  ];
