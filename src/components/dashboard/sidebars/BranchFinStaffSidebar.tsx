import { Banknote, FileTerminal, ArrowDownFromLine, ShieldCheck, Settings, Menu } from 'lucide-react';
...
const BranchFinStaffSidebar = ({ isSidebarCollapsed = false, toggleSidebar }: BranchFinStaffSidebarProps) => {
    return (
        ...
        >
            ...
            {!isSidebarCollapsed && <div className="px-5 py-4 text-xs font-bold tracking-wider transition-colors" style={{ color: 'var(--text-main)' }}>L4: FIN STAFF</div>}
