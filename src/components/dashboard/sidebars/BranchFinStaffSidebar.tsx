...
import { LayoutDashboard, FileText, Settings, Menu, ChevronDown, ChevronRight, LogOut, Car, Users, BarChart3, Plus } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="p-4 border-t space-y-1" style={{ borderColor: 'var(--border-main)' }}>
                <div
                    onClick={() => navigate('/admin/branch-fin-staff/dashboard-settings')}
