  ...
  const menuItems: MenuItem[] = [
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          path: "/admin/branch-fin-staff/collections/dashboard",
        },
        {
    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          path: "/admin/branch-fin-staff/collections/overdue",
        },
        {
          label: t("sidebar.items.upcomingPayments"),
          path: "/admin/branch-fin-staff/collections/upcoming",
        },
        {
          label: t("sidebar.items.invoicesLedger"),
          path: "/admin/branch-fin-staff/collections/invoices",
        },
      ],
    },
    {
      ...
      subItems: [
        ...
        */
        ...
        {
          label: t("sidebar.items.addJournalEntry"),
          path: "/admin/branch-fin-staff/ledger?action=create",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          path: "/admin/branch-fin-staff/my-tasks",
        },
        {
          label: t("sidebar.items.directivesDelegation"),
          path: "/admin/branch-fin-staff/directives",
        },
        {
          label: t("sidebar.items.accidentReports"),
          path: "/admin/branch-fin-staff/accident-reports",
        },
        {
          label: t("sidebar.items.manageVehicles"),
          path: "/admin/branch-fin-staff/vehicles",
        },
        {
          label: t("sidebar.items.manageDrivers"),
          path: "/admin/branch-fin-staff/drivers",
        },
        {
      ...
      subItems: [
        {
          ...
          path: "/admin/branch-fin-staff/dashboard-settings",
        },
        {
          label: t("sidebar.items.systemBulkUploads"),
          path: "/admin/branch-fin-staff/bulk-uploads",
        },
      ],
    },
  ];
