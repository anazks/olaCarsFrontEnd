...
const CountryManagerSidebar = ({
  isSidebarCollapsed = false,
  toggleSidebar,
}: CountryManagerSidebarProps) => {
      ...
      subItems: [
        {
          ...
          path: "/admin/country-manager/staff-management",
          permission: "STAFF_VIEW",
        },
        {
          label: t("sidebar.items.staffPerformance"),
          path: "/admin/country-manager/staff-performance",
          permission: "STAFF_PERFORMANCE_VIEW",
        },
        {
          label: t("sidebar.items.directivesDelegation"),
          path: "/admin/country-manager/directives",
          permission: "STAFF_PERFORMANCE_VIEW",
        },
      ...
      subItems: [
        {
          ...
          path: "/admin/country-manager/manage-workshops",
          permission: "STAFF_VIEW",
        },
        {
        ...
        },
        {
          ...
          path: "/admin/country-manager/manage-suppliers",
    ...
    },
    {
      ...
      subItems: [
...

        {
          ...
          path: "/admin/country-manager/accident-reports",
          permission: "STAFF_VIEW",
        },
      ],
    },
      ...
      subItems: [
        {
          ...
          path: "/admin/country-manager/collections/dashboard",
        },
        {
          label: t("sidebar.items.overduePayments"),
          path: "/admin/country-manager/collections/overdue",
        },
        {
          label: t("sidebar.items.upcomingPayments"),
          path: "/admin/country-manager/collections/upcoming",
        },
        {
          label: t("sidebar.items.invoicesLedger"),
          path: "/admin/country-manager/collections/invoices",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          path: "/admin/country-manager/dashboard-settings",
        },
        {
          label: t("sidebar.items.systemBulkUploads"),
          path: "/admin/country-manager/bulk-uploads",
        },
      ],
    },
  ];
