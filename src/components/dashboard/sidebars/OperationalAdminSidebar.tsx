...
const OperationalAdminSidebar = ({
  isSidebarCollapsed = false,
  toggleSidebar,
}: OperationalAdminSidebarProps) => {
  ...
  const menuItems: MenuItem[] = [
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          path: "/admin/operational-admin/collections/dashboard",
        },
        {
          label: t("sidebar.items.fleetDashboard"),
          path: "/admin/operational-admin/driver-performance",
        },
        {
          label: t("sidebar.items.financeDashboard"),
          path: "/admin/operational-admin/finance-dashboard",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          path: "/admin/operational-admin/staff-management",
          permission: "STAFF_VIEW",
        },
        {
          label: t("sidebar.items.staffPerformance"),
          path: "/admin/operational-admin/staff-performance",
          permission: "STAFF_PERFORMANCE_VIEW",
        },
        {
          label: t("sidebar.items.directivesDelegation"),
          path: "/admin/operational-admin/directives",
          permission: "STAFF_PERFORMANCE_VIEW",
        },
      ...
      subItems: [
        {
          ...
          path: "/admin/operational-admin/manage-workshops",
          permission: "STAFF_VIEW",
        },
        {
        ...
        },
        {
          ...
          path: "/admin/operational-admin/manage-suppliers",
      ...
      subItems: [
        {
          ...
          path: "/admin/operational-admin/vehicles",
          permission: "VEHICLE_VIEW",
        },
        {
          label: t("sidebar.items.pendingEntryVehicles"),
          path: "/admin/operational-admin/pending-vehicles",
          permission: "VEHICLE_VIEW",
        },
        {
          label: t("sidebar.items.manageDrivers"),
          path: "/admin/operational-admin/drivers",
        ...
        },
        {
          ...
          path: "/admin/operational-admin/agreements",
...

        {
          ...
          path: "/admin/operational-admin/accident-reports",
          permission: "STAFF_VIEW",
        },
      ],
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          path: "/admin/operational-admin/collections/overdue",
        },
        {
          label: t("sidebar.items.upcomingPayments"),
          path: "/admin/operational-admin/collections/upcoming",
        },
        {
          label: t("sidebar.items.invoicesLedger"),
          path: "/admin/operational-admin/collections/invoices",
        },
      ],
    },
    {
      ...
      subItems: [
        {
          ...
          path: "/admin/operational-admin/dashboard-settings",
        },
        {
          label: t("sidebar.items.systemBulkUploads"),
          path: "/admin/operational-admin/bulk-uploads",
        },
      ],
    },
  ];
