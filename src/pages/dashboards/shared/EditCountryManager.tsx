...
const EditCountryManager = () => {
    ...
    const loadData = async (adminId: string) => {
        ...
        setError(null);
        try {
            const data = await getCountryManagerById(adminId);
            setFormData({
                id: data._id,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('Country Manager updated successfully');
            navigate(-1);
        } catch (err: any) {
    ...
    return (
        <div className="space-y-6 animate-fadeInUp">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold" style={{ color: 'var(--text-main)' }}>Edit Country Manager</h1>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input type="text" value={formData.country} readOnly className="w-full px-4 py-3 rounded-xl outline-none text-sm cursor-not-allowed" style={{ background: 'var(--bg-input)', border: '1px solid var(--border-main)', color: 'var(--text-dim)' }} />
                                </div>
                            </div>
                        </div>
                    ) : (
...
export default EditCountryManager;
