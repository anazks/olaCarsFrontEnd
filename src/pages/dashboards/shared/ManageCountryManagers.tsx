            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold flex items-center gap-3" style={{ color: 'var(--text-main)' }}>
                        <Globe size={28} style={{ color: 'var(--brand-lime)' }} />
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b transition-colors duration-300" style={{ background: 'var(--bg-topbar)', borderColor: 'var(--border-main)' }}>
                                    ...
                                    <th className="px-6 py-4">
                                        <button onClick={() => handleSort('createdAt')} className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider outline-none hover:text-[var(--brand-lime)] transition-colors" style={{ color: 'var(--text-dim)' }}>
                                        ...
                                        >
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: 'rgba(200,230,0,0.15)', color: 'var(--brand-lime)' }}>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2" style={{ color: 'var(--text-main)' }}>
                                                    <Globe size={14} style={{ color: 'var(--brand-lime)' }} />
                                                    {manager.country || '—'}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                        ...
                                        <div className="flex flex-col justify-end pb-1">
                                            <label className="flex items-center gap-3 cursor-pointer group p-3 rounded-xl transition-all hover:bg-white/5 border" style={{ borderColor: 'var(--border-main)' }}>
                                                <div className="relative">
                                                    ...
                                                    />
                                                    <div className={`w-10 h-5 rounded-full transition-colors ${formData.twoFactorEnabled ? 'bg-[var(--brand-lime)]' : 'bg-gray-600'}`}></div>
