...
const ManageCountryManagers = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!emailRegex.test(formData.email.trim())) {
            setFormError(t('management.countryManagers.form.invalidEmailFormat', { defaultValue: 'Please enter a valid email address.' }));
        ...
        if (!phoneValidation.isValid) {
            ...
            switch (phoneValidation.errorKey) {
                case 'REQUIRED':
                    errorMsg = t('management.countryManagers.form.phoneRequired', { defaultValue: 'Phone number is required.' });
                    break;
                case 'REPEATED_DIGITS':
                    errorMsg = t('management.countryManagers.form.invalidPhoneRepeated', { defaultValue: 'Phone number cannot consist of repeated digits.' });
                    break;
                case 'TOO_SHORT':
                    errorMsg = t('management.countryManagers.form.phoneTooShort', { defaultValue: 'Phone number is too short.' });
                    break;
                case 'TOO_LONG':
                    errorMsg = t('management.countryManagers.form.phoneTooLong', { defaultValue: 'Phone number is too long.' });
                    break;
                case 'INVALID_FORMAT':
                default:
                    errorMsg = t('management.countryManagers.form.invalidPhoneLength', { defaultValue: 'Please enter a valid phone number.' });
                    break;
            }
                                                ...
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            const basePath = currentPath.split('/manage-country-managers')[0];
