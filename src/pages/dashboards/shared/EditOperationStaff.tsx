...
const EditOperationStaff = () => {
    ...
    const loadData = async (staffId: string) => {
        ...
        setError(null);
        try {
            const data = await getOperationStaffById(staffId);
            setFormData({
                id: data._id,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success('Operation Staff updated successfully');
            navigate(-1);
        } catch (err: any) {
    ...
    return (
        <div className="space-y-6 animate-fadeInUp">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold" style={{ color: 'var(--text-main)' }}>Edit Operation Staff</h1>
...
export default EditOperationStaff;
