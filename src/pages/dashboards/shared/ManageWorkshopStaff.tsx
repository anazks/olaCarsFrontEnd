...
const ManageWorkshopStaff = () => {
  ...
  const [selectedStaff, setSelectedStaff] = useState<WorkshopStaff | null>(
    null,
  );
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [staffRes, workshopsData] = await Promise.all([
      ...
      setError(
        err.response?.data?.message ||
          err.message ||
          t("management.workshopStaff.fetchFailed", {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (!emailRegex.test(formData.email.trim())) {
      setFormError(
        t("management.workshopStaff.form.invalidEmailFormat", {
    ...
    if (!phoneValidation.isValid) {
      ...
      switch (phoneValidation.errorKey) {
        case "REQUIRED":
          errorMsg = t("management.workshopStaff.form.phoneRequired", {
            defaultValue: "Phone number is required.",
          });
          break;
        case "REPEATED_DIGITS":
          errorMsg = t("management.workshopStaff.form.invalidPhoneRepeated", {
            defaultValue: "Phone number cannot consist of repeated digits.",
          });
          break;
        case "TOO_SHORT":
          errorMsg = t("management.workshopStaff.form.phoneTooShort", {
            defaultValue: "Phone number is too short.",
          });
          break;
        case "TOO_LONG":
          errorMsg = t("management.workshopStaff.form.phoneTooLong", {
            defaultValue: "Phone number is too long.",
          });
          break;
        case "INVALID_FORMAT":
        default:
          errorMsg = t("management.workshopStaff.form.invalidPhoneLength", {
    ...
    >
      <Breadcrumbs
        items={[
          ...
          { label: "Manage Workshop Staff", active: true },
        ]}
      />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p
            ...
            style={{ color: "var(--text-dim)" }}
          >
            {t("management.workshopStaff.subtitle")}
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <HasPermission permission="STAFF_CREATE">
            ...
            >
              <Plus size={20} /> {t("management.workshopStaff.add")}
            </button>
          </HasPermission>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        ...
        >
          <p
            ...
            style={{ color: "var(--text-dim)" }}
          >
            {t("management.common.stats.totalStaff", {
              defaultValue: "Total Staff",
            })}
          </p>
          <h3
        ...
        >
          ...
          <h3
            ...
            style={{ color: "var(--brand-lime)" }}
          >
            {workshopStaff.filter((s) => s.status === "ACTIVE").length}
          </h3>
        </div>
        <div
          className="p-5 rounded-2xl border transition-colors"
                ...
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center">
                    ...
                    <p className="text-sm" style={{ color: "var(--text-dim)" }}>
                      {t("management.workshopStaff.loading", {
                        defaultValue: "Loading workshop staff...",
                      })}
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center">
                    <p
                      ...
                      style={{ color: "var(--text-main)" }}
                    >
                      {t("management.workshopStaff.notFound")}
                    </p>
                  </td>
                </tr>
              ) : (
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        ...
                        {typeof staff.workshopId === "object"
                          ? staff.workshopId?.name
                          : workshops.find((b) => b._id === staff.workshopId)
                              ?.name || staff.workshopId}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span
                      ...
                      >
                        {t(
                          `management.common.status.${staff.status.toLowerCase()}`,
                        )}
                      </span>
                    </td>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          onClick={() => {
                            ...
                            navigate(
                              `${basePath}/staff-performance/${staff._id}`,
                            );
                          }}
                        ...
                        <HasPermission permission="STAFF_EDIT">
                          <button
                            onClick={() => navigate(`edit/${staff._id}`)}
                            className="p-2 rounded-lg hover:bg-lime/10 transition-colors"
                            style={{ color: "var(--text-dim)" }}
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                >
                  {modalMode === "create"
                    ? t("management.workshopStaff.modalTitleCreate")
                    : t("management.workshopStaff.modalTitleEdit")}
                </h2>
                <p className="text-sm" style={{ color: "var(--text-dim)" }}>
                  {modalMode === "create"
                    ? t("management.workshopStaff.subtitle")
              ...
              <div className="pt-4 flex items-center justify-end gap-3">
                ...
                >
                  {formLoading ? (
                    ...
                    t("management.workshopStaff.createButton")
                  ) : (
                    t("management.workshopStaff.updateButton")
                  )}
                </button>
              </div>
            </form>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            ...
            <h2
              ...
              style={{ color: "var(--text-main)" }}
            >
              {t("management.workshopStaff.deleteTitle")}
            </h2>
            <p
              className="text-sm mb-8 transition-colors"
              style={{ color: "var(--text-dim)" }}
            >
              {t("management.workshopStaff.deleteConfirm", {
