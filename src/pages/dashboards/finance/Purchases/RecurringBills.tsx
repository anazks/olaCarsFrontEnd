        ...
        <div className="container-responsive space-y-6">
            <Breadcrumbs 
                items={[
                    ...
                    { label: 'Recurring Bills', active: true }
                ]} 
            />
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-white/5 pb-4">
                <div>
                    ...
                    <p className="text-xs font-medium text-dim mt-0.5">Automate tracking of repeating vendor bills</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-12 rounded-2xl border border-dashed border-white/10 bg-white/[0.01]">
                ...
                <p className="text-[11px] text-dim mt-1 opacity-40">We are currently implementing full functionality for Recurring Bills.</p>
            </div>
        </div>
    );
};
