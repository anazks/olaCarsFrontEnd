...
const BankAccountLedger = () => {
    ...
    const renderDescriptionWithLinks = (description: string, entry?: any) => {
        ...
        if (matchedBills.length > 0 || matchedInvoices.length > 0) {
            return (
                <div className="flex flex-col gap-1.5">
                    <div className="text-sm font-semibold" style={{ color: 'var(--text-main)' }}>{cleanDesc || 'Transaction'}</div>
        ...
        return <div className="text-sm font-semibold" style={{ color: 'var(--text-main)' }}>{cleanDesc}</div>;
    };
