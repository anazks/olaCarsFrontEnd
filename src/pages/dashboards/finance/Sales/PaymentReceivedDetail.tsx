import { ArrowLeft, Calendar, User, Landmark, Coins, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
...
const PaymentReceivedDetail = ({ payment, onBack }: Props) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
                <button
                    onClick={onBack}
                    className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-xl border hover:bg-white/5 active:scale-95 transition-all text-xs font-black uppercase cursor-pointer"
            ...
            <div 
                className="w-full max-w-4xl mx-auto rounded-[2.5rem] border shadow-2xl flex flex-col p-6 sm:p-8 select-text"
